...
def test_gemini_candidates_are_converted() -> None:
    ...
    generator = GeminiCandidateGenerator(reasoner=FakeGeminiReasoner(proposal))
    ...
    assert candidate.experiment_id == "EXP-001"
...
def test_completed_experiment_is_filtered() -> None:
    ...
    # Pretend EXP-001 has already been executed.
